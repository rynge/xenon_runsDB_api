...
api.add_resource(RunDataObjectID, '/run/objectid/<ObjectId:object_id>/data')
api.add_resource(RunDataRunID, '/run/runnumber/<int:run_id>/data')
api.add_resource(RunDataTimestamp, '/run/timestamp/<string:timestamp>/data')
